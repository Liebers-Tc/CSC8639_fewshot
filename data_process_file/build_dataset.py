    ...
    def __getitem__(self, idx):
        ...
        for cls in selected_classes:
            ...
            for img_id in sampled_imgs[:self.k_shot]:
                ...
                support_mask = np.array(Image.open(mask_path))
                support_mask = (support_mask == int(cls)).astype(np.uint8) # 转化成二值mask
            ...
            for img_id in sampled_imgs[:self.q_query]:
                ...
                query_mask = np.array(Image.open(mask_path)).astype(np.int64)
